...
import 'package:listadeherois/models/hero.dart';

// class MinhaListaHome extends StatelessWidget {
//   final _myHerosList = [
//     MyHero("All Might", "One for All",
//         "https://abridgedseries.com/wp-content/uploads/2018/08/310613.jpg"),
//     MyHero("Midora", "One for All",
//         "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSLV14Wx4zF91WZE1LNZ5RAIGP0GrmlV57npA&usqp=CAU"),
//     MyHero("Baguko", "Explosão",
...
//         "https://i.pinimg.com/originals/2d/df/84/2ddf8471ddc8841a4b2ceeb3b5ca61ea.png"),
//   ];
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
class _MinhaListaHome3State extends State<MinhaListaHome3> {
      ...
      child: Scaffold(
        ...
        children: [
          ...
          meuTextFieldPersonalizado(
              controladorSingularidade,
              "Informe a singularidade do heroi",
              "Singularidade:",
  ...
  Widget meuTextFieldPersonalizado(TextEditingController controlador,
      String hint, String label, Icon icone) {
    return Padding(
  ...
  void adicionar_novo_registro() {
    setState(() {
      _myHerosList.add(MyHero(controladorNome.text,
          controladorSingularidade.text, controladorUrlImage.text));
      print(_myHerosList);
    });
  }
}
